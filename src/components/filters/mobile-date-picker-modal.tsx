          ...
          <div className="bg-background-tertiary rounded-xl p-3">
            <DayPicker
              ...
              classNames={{
                ...
                button_previous: "absolute left-0 p-2 rounded-lg hover:bg-background-active text-text-secondary hover:text-text-primary transition-colors",
                button_next: "absolute right-0 p-2 rounded-lg hover:bg-background-active text-text-secondary hover:text-text-primary transition-colors",
                month_grid: "w-full",
