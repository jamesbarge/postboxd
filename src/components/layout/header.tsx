          ...
          <div className="p-3 border-b border-border-subtle">
            ...
            <DayPicker
              ...
              classNames={{
                ...
                month: "space-y-2",
                month_caption: "flex justify-center relative items-center h-10 mb-3",
                caption_label: "text-sm font-medium text-text-primary",
                nav: "space-x-1",
                button_previous: "absolute left-2 top-1/2 -translate-y-1/2 p-1.5 rounded-md bg-background-tertiary text-text-secondary hover:bg-background-active hover:text-text-primary transition-colors",
                button_next: "absolute right-2 top-1/2 -translate-y-1/2 p-1.5 rounded-md bg-background-tertiary text-text-secondary hover:bg-background-active hover:text-text-primary transition-colors",
                month_grid: "w-full",
