/**
 * Run script for Prince Charles Cinema Season Scraper
 *
 * Usage: npm run scrape:pcc-seasons
 */

import { createPCCSeasonScraper } from "./pcc";
import { processSeasons } from "./pipeline";

async function main() {
  console.log("🎬 Starting Prince Charles Cinema Season scraper...\n");

  const scraper = createPCCSeasonScraper();
