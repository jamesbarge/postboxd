/**
 * Run script for Barbican Season Scraper
 *
 * Usage: npm run scrape:barbican-seasons
 */

import { createBarbicanSeasonScraper } from "./barbican";
import { processSeasons } from "./pipeline";

async function main() {
  console.log("🎬 Starting Barbican Season scraper...\n");

  const scraper = createBarbicanSeasonScraper();
  ...
  console.log("\n✅ Barbican Season scrape complete!");
  process.exit(0);
}
