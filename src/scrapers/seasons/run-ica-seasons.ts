/**
 * Run script for ICA Season Scraper
 *
 * Usage: npm run scrape:ica-seasons
 */

import { createICASeasonScraper } from "./ica";
import { processSeasons } from "./pipeline";

async function main() {
  console.log("🎬 Starting ICA Season scraper...\n");

  const scraper = createICASeasonScraper();
